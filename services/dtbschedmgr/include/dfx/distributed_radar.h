...
constexpr const char* ORG_PKG_NAME = "ohos.distributedschedule";
constexpr const char* APPLICATION_CONTINUE_BEHAVIOR = "APPLICATION_CONTINUE_BEHAVIOR";
constexpr const char* ABILITY_MANAGER_SERVICE = "ohos.abilitymanagerservice";
constexpr const char* INIT = "init";
constexpr const char* NORMAL = "normal";
constexpr const char* MULTIMODE = "multimode";
constexpr const char* DEVICEONLINE = "deviceonline";
constexpr const char* FOCUSED = "focused";
constexpr const char* UNFOCUSED = "unfocused";
constexpr const char* BMS_PKG_NAME = "foundation_bms";
constexpr const char* DBMS_PKG_NAME = "d_bms";
constexpr const char* DSOFTBUS_PKG_NAME = "dsoftbus";
...
constexpr const char* HOST_PKG = "HOST_PKG";
constexpr const char* ERROR_CODE = "ERROR_CODE";
constexpr const char* PEER_UDID = "PEER_UDID";
constexpr const char* APP_CALLEE = "APP_CALLEE";
constexpr const char* APP_CALLER = "APP_CALLER";
constexpr const char* LOCAL_APP_VERSION = "LOCAL_APP_VERSION";
constexpr const char* PEER_APP_VERSION = "PEER_APP_VERSION";
