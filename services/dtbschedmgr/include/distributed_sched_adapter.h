...
public:
    ...
    int32_t RegisterMissionListener(const sptr<AAFwk::IMissionListener>& listener);
    int32_t UnRegisterMissionListener(const sptr<AAFwk::IMissionListener>& listener);
