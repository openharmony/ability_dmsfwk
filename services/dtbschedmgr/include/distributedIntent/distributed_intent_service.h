...
#ifndef OHOS_DISTRIBUTED_INTENT_SERVICE_H
#define OHOS_DISTRIBUTED_INTENT_SERVICE_H
...
class DistributedIntentService : public DistributedIntentServiceStub {
public:
    DistributedIntentService();
    ~DistributedIntentService() override;
...
#endif // OHOS_DISTRIBUTED_INTENT_SERVICE_H
